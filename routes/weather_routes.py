...
from controllers.weather import login, signup, home, year, month, chart, h_chart, v_chart
...
reading_bp.route('/chart/horizontal-chart/', methods=['GET', 'POST'])(h_chart)
reading_bp.route('/chart/vertical-chart/', methods=['GET', 'POST'])(v_chart)
